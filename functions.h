...
extern surface_pointer *getGlobalSurfacePointer(global_surfaces *GLOBAL_SURFACES, int surfaceNumber);
...
extern adjacent_points *findGlobalAdjacentPoints(surface_pointer *SURFACE_POINTER, double lat, double lon);
extern void findCornerInds(surface_pointer *SURFACE_POINTER, double latPt, double lonPt, adjacent_points *ADJACENT_POINTS);
extern void findEdgeInds(surface_pointer *SURFACE_POINTER, adjacent_points *ADJACENT_POINTS, int edgeType);
...
extern nz_tomography_data *loadEPtomoSurfaceData(char *tomoType);
extern surface_pointer *getTomographySurfacePointer(nz_tomography_data *NZ_TOMOGRAPHY_DATA, int surfaceNumber, char *quality);
